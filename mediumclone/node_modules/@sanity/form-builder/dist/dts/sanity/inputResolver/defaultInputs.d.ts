...
declare const _default: {
    ...
    image: import("react").ForwardRefExoticComponent<{
        ...
        materialize: (documentId: string) => import("rxjs").Observable<import("@sanity/types/src").SanityDocument>;
    ...
    file: import("react").ForwardRefExoticComponent<{
        ...
        level: number;
        resolveUploader: import("../uploads/types").UploaderResolver;
        materialize: (documentId: string) => import("rxjs").Observable<import("@sanity/types/src").FileAsset>;
        directUploads?: boolean;
    } & import("react").RefAttributes<unknown>>;
